        ...
        for i in range(1, depth_decode):
            ...
            X_nest_skip[nest_lev].append(
                UNET_right(X_nest_skip[nest_lev - 1][i], previous_skip, filter_num[i - 1],
                           ...
                           batch_norm=batch_norm, concat=False,
...
def uneteffnet(input_size, filter_num, n_labels, stack_num_down=2, stack_num_up=2,
    ...
    if deep_supervision:
        ...
        # other backbones
            ...
            for i in range(1, depth_ - 1):
                ...
                X = CONV_output(X, n_labels, kernel_size=1, activation=output_activation,
        ...
        OUT_list.append(CONV_output(X_list[-1], n_labels, kernel_size=1, activation=output_activation,
