...
def YoloV2(input_shape, CLASS=2, BOX=5, GRID_H = 8,  GRID_W  = 8):
    ...
    # Layer 1
    x = Conv2D(32, (3, 3), strides=(1, 1), padding='same', name='conv_1', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(input_image)
    ...
    # Layer 2
    x = Conv2D(64, (3, 3), strides=(1, 1), padding='same', name='conv_2', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    ...
    # Layer 3
    x = Conv2D(128, (3, 3), strides=(1, 1), padding='same', name='conv_3', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_3')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 4
    x = Conv2D(64, (1, 1), strides=(1, 1), padding='same', name='conv_4', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_4')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 5
    x = Conv2D(128, (3, 3), strides=(1, 1), padding='same', name='conv_5', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    ...
    # Layer 6
    x = Conv2D(256, (3, 3), strides=(1, 1), padding='same', name='conv_6', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_6')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 7
    x = Conv2D(128, (1, 1), strides=(1, 1), padding='same', name='conv_7', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_7')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 8
    x = Conv2D(256, (3, 3), strides=(1, 1), padding='same', name='conv_8', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    ...
    # Layer 9
    x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', name='conv_9', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_9')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 10
    x = Conv2D(256, (1, 1), strides=(1, 1), padding='same', name='conv_10', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_10')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 11
    x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', name='conv_11', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_11')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 12
    x = Conv2D(256, (1, 1), strides=(1, 1), padding='same', name='conv_12', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_12')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 13
    x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', name='conv_13', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    ...
    # Layer 14
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_14', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_14')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 15
    x = Conv2D(512, (1, 1), strides=(1, 1), padding='same', name='conv_15', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_15')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 16
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_16', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_16')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 17
    x = Conv2D(512, (1, 1), strides=(1, 1), padding='same', name='conv_17', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_17')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 18
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_18', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_18')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 19
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_19', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_19')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 20
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_20', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
    x = BatchNormalization(name='norm_20')(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.2)(x)

    # Layer 21
    skip_connection = Conv2D(64, (1, 1), strides=(1, 1), padding='same', name='conv_21', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(
        skip_connection)
    ...
    # Layer 22
    x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_22', kernel_initializer='glorot_uniform', use_bias=False, kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
...
def setWeights(weightFile, model, GRID_H = 8, GRID_W = 8):
    ...
    weight_reader = WeightReader(weightFile)
...
def yolov2_loss(detector_mask, matching_true_boxes, class_one_hot, true_boxes_grid, y_pred, info=False, GRID_H = 8, GRID_W = 8):
    ...
    matching_true_boxes = tf.cast(matching_true_boxes, tf.float32)
    ...
    pred_mins = tf.cast(pred_mins, tf.float32)
    true_mins = tf.cast(true_mins, tf.float32)
    pred_maxes = tf.cast(pred_mins, tf.float32)
    true_maxes = tf.cast(true_mins, tf.float32)
    ...
    pred_areas = tf.cast(pred_areas, tf.float32)
    true_areas = tf.cast(true_areas, tf.float32)
    intersect_areas = tf.cast(intersect_areas, tf.float32)
...
def grad(model, img, detector_mask, matching_true_boxes, class_one_hot, true_boxes, training=True):
    ...
    matching_true_boxes = tf.convert_to_tensor(matching_true_boxes, dtype=tf.float64)
    true_boxes = tf.cast(true_boxes, tf.float64)
...
def save_best_weights(model, name, val_loss_avg):
    ...
    path_name = os.path.join('results/', name)
...
def train(epochs, model, train_dataset, val_dataset, steps_per_epoch_train, steps_per_epoch_val, train_name='train', callbacks=None):
    '''
